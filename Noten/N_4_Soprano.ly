...
KyrieISopranoSoloIncipit = \markup {
	\center-column { "Soprano" "Solo I, II" } \hspace #-18.3 \score {
		\new Staff \with {
			\remove Time_signature_engraver
		} {
			\clef soprano s4 \bar empty
...
KyrieISopranoSoloNotes = {
	\clef treble
	\key b \major \time 4/4 \tempoKyrieI
	<< \relative c' \new Voice = "SopranoSolo" {
		\autoBeamOff \dynamicUp \oneVoice R1*5 %5
		\mvTr b'4.\fE^\tuttiE b8 b2
		r2 b4. b8
		b4 r c4. c8
		d4. d8 c a b c
		...
		c8. c16 c8 c d4.( d8
		e4 f d c8) c
		c8 \voiceOne c^\solo c c b4 r
		r8 a a a g r r4
		r8 c4 d16([ c)] b4 r %15
		r8 a a a g4 r
		\oneVoice r8 c^\tutti b d c4 a
		g4. g8 a4 r
		R1
		r2 r4 c8. c16 %20
		d8 d d d c4 c8. c16
		c8 es d c b4 r
		r8 c f4.( b,8 es4~
		es8[ f16 es] d8) c h r \voiceOne es8.^\solo es16
		d4 d8. d16 c4 \oneVoice c8.^\tutti c16 %25
		d8 d e e f c d d
		\appoggiatura d4 c4~ c8 r r2
		es4. es8 d4 r
		c4. c8 f,4. d'8
		...
		r4 r8 a( b[ d c es]
		c4 d) c4. c8
		d8 \voiceOne f^\solo f f es4 r
		r d8. d16 c4 r
		r f8. f16 es4 r %35
		r8 d d d c4 r
		r8 \oneVoice d^\tuttiE es es c4 d
		c4. c8 d4 r
		R1*3
	} \\ \relative c' {
		\autoBeamOff s1*12
...
KyrieISopranoSoloLyrics = \lyricmode {
	Ky -- ri -- e, %6
	Ky -- ri --
	e, Ky -- ri --
	e e -- le -- i -- son, e --
...
DomineSopranoNotes = {
	\relative c' {
		...
		c4\fermata r r2
		R1*3 %335
		R1\fermataMarkup \bar "||" %336 finis
	}
}
...
QuiTollisSopranoIINotes = {
	\relative c' {
		...
		d2 c h~
		h( c4 h) a2~
		a( \once \stemUp h4 a gis fis) %380
		gis1.~
...
QuoniamSopranoNotes = {
	\relative c' {
		...
		c4\fermata r
		R2*2 %680
		R2\fermataMarkup \bar "||" %681 finis
	}
}
