...
KyrieIAltoNotes = {
	\relative c' {
		...
		a8. a16 a4 r8 f \stemUp b4~
		b( \stemNeutral a g4.) g8
		a4 r r g8. g16
		f4 r r8 b a g
		f4 r r g8. g16 %15
		f4 r r8 b a g
...
GratiasAltoNotes = {
	...
	\relative c' {
		\clef treble
		\key e \minor \time 2/4 \autoBeamOff \tempoGratias
		...
		fis4 r
		R2
		h8 h4( \appoggiatura a16 g8)
		fis16([ e)] e4. %185
		c'8 c4( \appoggiatura h16 a8)
		g16([ fis)] fis4.
		a8 d,4 a'8
		h16[ g c a] d8 r
		a d,4 a'8 %190
...
QuiSedesAltoNotes = {
	...
	\relative c' {
		\clef treble
		\key d \major \time 2/4 \autoBeamOff \tempoQuiSedes
		...
		d\fermata r
		R2*4 %521
		R2\fermataMarkup \bar "||" %522 finis
	}
}
