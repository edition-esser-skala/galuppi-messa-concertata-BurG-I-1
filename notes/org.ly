...
KyrieIOrgano = {
  \relative c {
    ...
    c d8 b es4. es8
    as4 f g es-\markup \remark "Vlc. soli "
    f g as es-\tutti %25
    f g a8 f b b,
    f'4 f16 es d c b4 b
    b b b b
...
KyrieIIBassFigures = \figuremode {
  ...
  <4>4 <3> <2> <6>
  <5 2> <[6]> <4> <3>
  \bo <[5 2]> \bc <[6 \l]> <4> <3> %245
  \bo <[5 2]> \bc <[6 \l]> <6- 5> <[5-]>8 <6>
  <6 5>2 <7 _->4 <6>8 <5!>
  <[_!]>1
  <6 5>2 <5 3>
  <6 5> <5 3> %250
...
GloriaOrgano = {
  \relative c {
    ...
    d r r
    R2.
    \clef bass \mvTr d4\fE-\tutti d, r %140
    d' d, r
    d d d
    g g, r
    g' g, r
...
GloriaBassFigures = \figuremode {
  ...
  <5+ _+>2. %100
  <7! _+>
  \bo <7 [_+]>2 \bassFigureExtendersOn \bc <7 [_+]>4 \bassFigureExtendersOff
...
GratiasBassFigures = \figuremode {
  ...
  <_+>2
  r4 <6>8 <[_+]>
  r8 \bo <[5]>4 \bassFigureExtendersOn \bc q8 \bassFigureExtendersOff
  <6>4 <6 4>8 <5 _+> %205
  r2
  <7>8 <[6]> <6 5>4
...
QuiSedesBassFigures = \figuremode {
  ...
  r8 <5 3> <6 4> <6 4+>
  <6>2 %490
  r8 \bo <6 [_!]>4 \bassFigureExtendersOn \bc q8 \bassFigureExtendersOff
  <6 5>2
  r
  <6 5>
  r4 \bo <[6]> %495
  ...
  r4 \bo <[5]>8 \bc <[6]>
  <6 4>4 <5 3>
  \bo <[5! \l]>4 <6+ 4>8 \bassFigureExtendersOn <6+ 4> %515
...
CredoBassFigures = \figuremode {
  ...
  <[5+] _+>2.
  q
  <7 5>4 \bo <[6 4]> \bc <[5+ _+]> %70
  r2.
  \bo <[5!] 3>2 \bassFigureExtendersOn <5! 3>8 q
  <6+>2 q8 \bc <[6+]> \bassFigureExtendersOff
  <6 [_!]>2.
  r4 <6 4> <5+ _+> %75
  r2.
  <[6-] 4 2>
  ...
  r2.
  r %112 finis
  r2 r8 <_->4 \bassFigureExtendersOn q8 \bassFigureExtendersOff
  <7->2 r8 <[_-]>4 \bassFigureExtendersOn <_->8 \bassFigureExtendersOff
  <[7-]>1 %115
  r2 <_->4 <6! [5-]>
  <[_!]>1
  <6- 5->
...
BenedictusOrgano = {
  \relative c {
    ...
    c4 r8 h g h
    c f g g g, g
    c g c,4 r\fermata \markOsannaE \bar "||" %163 FINIS
  }
}
